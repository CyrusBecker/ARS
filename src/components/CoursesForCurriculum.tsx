...
const CoursesForCurriculum: React.FC = () => {
  ...
  const handleSave = async () => {
    try {
      const res = await fetch("http://localhost:3000/api/curriculum-subjects", {
        method: "POST",
  ...
  return (
    <Box p={3}>
      ...
      Editing Curriculum ID: {curriculumId} {curriculumInfo ? `(${curriculumInfo.AcademicYear} - ${curriculumInfo.ProgramCode})` : ''}
      </Typography>
            ...
            <TableRow key={idx}>
              <TableCell>
                ...
                {idx === 0 ? (
                  ...
                  <IconButton onClick={() => deleteRow(idx)}><Delete /></IconButton>
                )}
              </TableCell>
              <TableCell>
                <Select
              ...
              <TableCell>
                <Autocomplete
                  ...
                  value={row.Course_Code ? subjSuggest.find((s) => s.CourseCode === row.Course_Code) : undefined}                  
              ...
              <TableCell>
                <TextField
                  ...
                  onChange={(e) => inputChange(idx, 'Course_Name', e.target.value)}
                />
              </TableCell>
              <TableCell>
                <TextField
