...
import ProfessorSchedModification from "./components/ProfessorSchedModification";
import AssigningProfessors from "./components/AssigningProfessors";
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/curriculumOverview"
          element={<CurriculumList /* Listing Existing Curriculums */ />}
        />
        <Route
          path="/curriculum-management"
          element={
            <CurriculumManagement /> /* Planned for later || The selection for Programs */
          }
        />
        <Route
          path="/curriculum/add"
          element={
            <CreateNewCurriculum /* Curriculum Creation, some load are still missing */
            />
          }
        />
        <Route
          ...
          element={
            <CoursesForCurriculum /* Curricculum Edit, some load are still missing */
            />
          }
        />
        <Route
          path="/curriculum/view/:id"
          element={<AddCourses /> /* Almost done */}
        />
        <Route path="/scheduleOverview" element={<SectionList /*  */ />} />
        <Route
          path="/schedule/view/:sectionId"
          element={<LoadSectSched /> /*  */}
        />
        <Route
          path="/schedule/create/:sectionId"
          element={<ScheduleCreation /> /*  */}
        />
        <Route
          path="/schedule/assign/:sectionId"
          element={<AssigningProfessors />}
        />
        <Route path="/facultyOverview" element={<FacultyLoading /> /*  */} />
        <Route path="/faculty/add" element={<AddProf />} /*  */ />
        <Route
          path="/faculty/edit/:id"
          element={<EditProfessorSubjects /> /*  */}
        />
        <Route
          path="/faculty/schedule/:id"
          element={<ProfessorSchedModification /> /*  */}
        />
        <Route
          path="/login"
          element={<Login /> /* Too Bare || Non-functional */}
        />
      </Routes>
    </Router>
  );
